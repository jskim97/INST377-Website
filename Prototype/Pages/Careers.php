...
<html lang="en">
<head>
  <title>Entry level and Internships</title>
  <meta charset="utf-8">
...
.bg-image {
  /* The image used */
  background-image: url("./Pictures/Database1.jpeg");
...
<div class="bg-text">
  <h2><p style="color:White;"><b>Careers and Internship Database</b></p></h2>
  <p>Entry Level and Internships</p>
</div>
</div>
...
<div class="container">
  <h2><b>Entry-level and Internship Database</b></h2>
  <p><b>Type in the search bar to filter out results (e.g. "Lockheed"):</b></p>
    ...
    <tbody id ="myTable">
       <?php // query.php
        ...
        for ($j = 0 ; $j < $rows ; ++$j)
        {
          ...
          $result->data_seek($j);
          echo '<td> ' . $result->fetch_assoc()['Date_Posted'] . '</td>';
          echo '</tr>';
        }
        $result->close();
        $conn->close();
