...
<html lang="en">
<head>
  <title>Resume and Cover Letter Resume Resource Database</title>
  <meta charset="utf-8">
...
.bg-image {
  /* The image used */
  background-image: url("./Pictures/Checking.jpg");
...
<div class="bg-text">
  <h1><p style="color:White;"><b>Resume & Cover Letter Resource Database</b></p></h1>
  <p>Check out our recommended resources for writing resumes and cover letters!</p>
</div>
</div>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="./Careers.html"><p style="color:White;">Career and Internship Database</p></a></li>
        <li class="dropdown">
        ...
        <span class="caret"></span></a>
         <ul class="dropdown-menu">
          ...
          <li class="active"><a href="./ResumeDB.html">Resume and Cover Letter Resource Database</a></li>
        </ul>
      </li>
...
<div class="container">
  <h2><b>Resume and Cover Letter Resource Database</b></h2>
  <p><b>Type in the search bar to filter out results (e.g. "Database Administrator"):</b></p>
    ...
    <tbody id ="myTable">
      <?php // query.php
        ...
        for ($j = 0 ; $j < $rows ; ++$j)
        {
          $result->data_seek($j);
          echo '<tr>';
          echo '<td>' . $result->fetch_assoc()['Resouce_Name'] . '</td>';
          $result->data_seek($j);
